...
docker run -v $dataDirectoryPath:/etc/newman --network="sugar11_default" postman/newman_ubuntu1404 run "ProfessorM_PostmanCollection.json" --environment="ProfessorM_PostmanEnvironment.json" --color off --reporters="cli"
