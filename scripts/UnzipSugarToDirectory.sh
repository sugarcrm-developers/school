...
then
    echo "Not all required command line arguments were set. Please run the script again with the required arguments:
        ...
        For example: ./UnzipSugarToDirectory.sh SugarEnt-11.0 workspace/sugardocker/data/app/sugar"
    exit 1
fi
...
# The unzipped copy of Sugar will have the full name like 'SugarEnt-Full-11.0.0.0-dev.1'
